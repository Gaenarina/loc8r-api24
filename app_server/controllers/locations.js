...
const homelist = (req, res) => {
  ...
  const requestOptions = {
    ...
    qs: {
      ...
      lng: 127.262811739654,
      lat: 37.0098408255539,
      maxDistance: 200000
      /*
      lng: 1,
      lat: 1,
...
const renderDetailPage = (req, res, location) => {
  res.render('location-info', {
    ...
    sidebar: {
      contex: 'is on Loc8r because it has accessible wifi and\
...
const ShowError = (req, res, status) => {
  ...
  if (status === 404) {
    ...
    title = `${status}, something's gone worng`;
    content = 'Something, somewhere, has gone just a little bit worng.';
  }
  res.status(status);
